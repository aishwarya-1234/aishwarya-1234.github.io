...
public class OrderListAdapter extends ArrayAdapter<SingleModel> {
    private List<SingleModel> singleModelList;
    private Context context;

    public OrderListAdapter(List<SingleModel> singleModelList, Context context) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        String str ="<b> Name:&nbsp;&nbsp;&nbsp;&nbsp;</b>"+singleModel.getData();
