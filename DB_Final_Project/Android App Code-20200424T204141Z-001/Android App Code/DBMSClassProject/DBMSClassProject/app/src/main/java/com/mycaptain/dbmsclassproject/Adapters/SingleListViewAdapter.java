...
public class SingleListViewAdapter extends ArrayAdapter<SingleModel> {
    private List<SingleModel> singleModelList;
    private Context context;

    public SingleListViewAdapter(List<SingleModel> singleModelList, Context context) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        String strName="<b>Person Name: &nbsp;&nbsp;&nbsp;&nbsp;</b>"+singleModel.getData();
