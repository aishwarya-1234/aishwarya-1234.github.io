...
public class DirectedMovies10Fragment extends Fragment {


    private  static final String url= "http://demomvcapp-env.eba-sz3rwy35.us-east-1.elasticbeanstalk.com/Database%20Class%20Project/view/results2.json";
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        View view = inflater.inflate(R.layout.fragment_directed_movies_10, container, false);
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    for(int i=0;i<jsonArray.length();i++){
                       ...
                       SingleListViewAdapter adapter = new SingleListViewAdapter(singleModelArrayList,getContext());
